...
This page demonstrates the Markdown capabilities and styling for Academic Pages.
...
* Single pages: _pages/
* Collections of pages are .md files in:
  * _publications/
  * _portfolio/
  * _posts/
  * _teaching/
...
**Watch out!** You can also add notices by appending `{: .notice--primary}` to a paragraph.
{: .notice--primary}
